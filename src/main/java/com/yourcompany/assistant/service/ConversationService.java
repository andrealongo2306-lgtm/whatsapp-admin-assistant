...
public class ConversationService {
    ...
    private String handleInitialState(Conversation conversation, String message) {
        ...
        return "Benvenuto! Sono il tuo assistente per la gestione delle autorizzazioni alla fatturazione. Per quale mese e anno desideri procedere? (es: Gennaio-2024)";
    }
