...
public class SessionCleanupScheduler {
    ...
    public void monthlyBillingReminder() {
        ...
        try {
            ...
            String message = "Ciao Andrea! Sono il tuo assistente per la fatturazione. "
                    + "Per quale mese vuoi inviare l'autorizzazione? "
                    + "Inserisci mese e anno nel formato Mese-Anno (es: Gennaio-2026).";
